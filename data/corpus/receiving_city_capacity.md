# Receiving City Capacity: Housing, Labor, and Public Services

## Housing market tightness

Vacancy rates below 3% are generally considered a tight housing market.
Cities in this range absorb new arrivals slowly and tend to see rapid rent
increases as soon as migration spikes, because there is very little slack
inventory to accommodate sudden population growth. A vacancy rate above
5-6% indicates a much more elastic market that can absorb a meaningful
wave of new residents without an immediate price shock. Housing vacancy is
therefore one of the single most important early indicators of whether a
receiving city can sustain a migration influx without a affordability
crisis.

## Three commonly used proxies for public services absorption capacity

When housing and labor market data are unavailable at sufficient
...
## Weighting housing and labor market capacity vs. public services
...
migration has already occurred and people have chosen to stay. A capacity
score that weights the two evenly, or weights public services more
heavily, tends to systematically over-estimate a city's true absorption
capacity in the first 12-24 months of an influx, which is the period that
matters most for acute strain.
...
infrastructure (driven by the capacity shortfall): rents rise sharply,
school waitlists grow, and informal or overcrowded housing arrangements
become more common. This is precisely the scenario a push/pull corridor
risk score is designed to flag before it happens, rather than after.
